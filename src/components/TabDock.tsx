...
export function TabDock() {
  ...
  return (
    <>
      {v.hasTabs && (
        <div style={sx("position:absolute;left:50%;bottom:26px;transform:translateX(-50%);z-index:30;display:flex;gap:8px;padding:9px 14px;border-radius:99px;background:rgba(30,28,48,.72);border:1px solid rgba(58,55,82,.8);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)")}>
